...
exports.PromptHubProvider = void 0;
const vscode = require("vscode");
const fs = require("fs");
class PromptHubProvider {
    ...
    async _handleWebviewMessage(message) {
        switch (message.type) {
            ...
            case 'showNotification': {
                this._showNotification(message.message, message.notificationType);
                break;
            }
     ...
     */
    _showNotification(message, type = 'info', modal = false) {
        if (modal) {
    ...
    async _showInputBox(prompt, value) {
...
exports.PromptHubProvider = PromptHubProvider;
PromptHubProvider.viewType = 'promptHubView';
//# sourceMappingURL=promptHubProvider.js.map